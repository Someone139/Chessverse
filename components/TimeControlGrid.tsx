...
import { Settings, Clock, Plus, CirclePlus } from "lucide-react";
            ...
            {showTimeControlModal && (
                <>
                    ...
                    <div className="fixed flex flex-col self-center left-1/2 -translate-x-1/2 items-center z-50 rounded-xl bg-background-100 w-150 h-140 shadow-2xl border border-border">
                        {/* Title */}
                        <div className='flex gap-1 items-center bg-secondary-100 justify-center rounded-t-xl border-b border-border p-4 w-full mb-3'>
                            <Settings size={40}/>
                                    ...
                                    <div className="flex items-center text-2xl font-black text-text-950 rounded-lg bg-secondary-400 px-1 w-24">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                const validatedMins = Math.min(Math.max(0, mins));
